...
RUN pip3 install ruamel.yaml opencv-python cvlib matplotlib tensorflow keras==2.1.6 flask numpy ruamel.yaml tqdm seaborn Cython torch torchvision GitPython scikit-image
